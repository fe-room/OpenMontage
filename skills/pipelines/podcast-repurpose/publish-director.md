...
Package the approved `cover_package.primary_cover.path` and any clip-specific
variants. Do not replace real covers with speaker-card concepts during publish.
