# xiaosan-economics-03-opportunity-cost — atelier (bespoke) composition

Hand-authored Remotion composition. Source of truth lives here under
`projects/xiaosan-economics-03-opportunity-cost/`; at render time the atelier path auto-stages a junction at
`remotion-composer/projects/xiaosan-economics-03-opportunity-cost/` so the bundler can resolve `node_modules`.
...
P = r"projects\\xiaosan-economics-03-opportunity-cost"  # absolute path on your machine
